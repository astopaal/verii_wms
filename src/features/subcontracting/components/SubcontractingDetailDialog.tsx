...
import type { SubcontractingLine } from '../types/subcontracting';
              ...
              <div className="flex-1 overflow-y-auto rounded-md border">
                {isLoadingLines ? (
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {filteredLines.map((line: SubcontractingLine) => (
                        <SubcontractingLineRow key={line.id} line={line} documentType={documentType} />
                      ))}
                    </TableBody>
                  </Table>
                )}
...
function SubcontractingLineRow({ line, documentType }: SubcontractingLineRowProps): ReactElement {
