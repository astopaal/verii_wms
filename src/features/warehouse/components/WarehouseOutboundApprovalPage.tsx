...
export function WarehouseOutboundApprovalPage(): ReactElement {
  ...
  const { data, isLoading, error } = useAwaitingApprovalWoHeaders({
    pageNumber,
    pageSize,
    sortBy,
    sortDirection,
        ...
        <CardContent>
          <div className="hidden md:block rounded-md border">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>{t('warehouse.outbound.approval.id', 'ID')}</TableHead>
                  <TableHead>{t('warehouse.outbound.approval.documentNo', 'Belge No')}</TableHead>
                  <TableHead>{t('warehouse.outbound.approval.documentDate', 'Belge Tarihi')}</TableHead>
                  <TableHead>{t('warehouse.outbound.approval.customerCode', 'Cari Kodu')}</TableHead>
                  <TableHead>{t('warehouse.outbound.approval.customerName', 'Cari Adı')}</TableHead>
                  <TableHead>{t('warehouse.outbound.approval.sourceWarehouse', 'Depo')}</TableHead>
                  <TableHead>{t('warehouse.outbound.approval.completionDate', 'Tamamlanma Tarihi')}</TableHead>
                  <TableHead>{t('warehouse.outbound.approval.actions', 'İşlemler')}</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
